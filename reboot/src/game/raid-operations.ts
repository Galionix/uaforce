...
export const RAID_OPERATIONS:Mission[]=[
 {...common,name:'Планове займання',region:'Росія · тилові склади',brief:'За кордоном — склад, який живить наступ. Знищіть три арсенали. Бочки запускають ланцюгову реакцію: бийте здалеку або з верхніх містків. Наступна ціль — аеродром.',atmosphere:'ash',theme:'rail',score:'rail',background:'/assets/raids/depot-pixel-background.png',length:184,exit:177,radio:166,mounts:[10,122],
