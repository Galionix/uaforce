...
export const RAID_OPERATIONS:Mission[]=[
 {...common,name:'Планове займання',region:'Росія · тилові склади',brief:'За кордоном — склад, який живить наступ. Знищіть три арсенали. Бочки запускають ланцюгову реакцію: бийте здалеку або з верхніх містків. Наступна ціль — аеродром.',theme:'rail',score:'rail',background:'/assets/raids/depot-pixel-background.png',length:184,exit:177,radio:166,mounts:[10,122],
 ...
 surfaces:[floor(29,62,6),floor(82,111,8),floor(117,157,6)],ladders:[ladder(30,6),ladder(60,6),ladder(83,8),ladder(110,8),ladder(118,6),ladder(156,6)],
 props:[...group(39),...group(88),...group(140),...group(97,8),...group(145,6)],targets:[target(47,'ammo'),target(96,'ammo'),target(148,'ammo')],
 guards:[guard(16,0,'scout'),guard(37,0,'rifle'),guard(52,6,'gunner'),guard(65,0,'shield'),guard(86,0,'assault'),guard(104,8,'sniper'),guard(115,0,'demolition'),guard(136,0,'shield'),guard(143,6,'gunner'),guard(159,0,'assault'),guard(173,0,'gunner',true)],
