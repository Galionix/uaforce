...
export const NEW_OPERATIONS:Mission[]=[
 {...common,name:'Вище за наказ',region:'Київ',brief:'Обійдіть заводський двір, підніміться крізь цех і вийдіть на дахи. Захопіть позначені пости та здолайте командира біля евакуації.',atmosphere:'drizzle',theme:'city',score:'city',background:'/assets/kyiv-pixel-background.png',length:154,exit:146,radio:137,
 ...
 {...common,name:'Перевал нескорених',region:'Карпати',brief:'Підніміться уступами до канатної станції. Перетинайте мости, обходьте вогневі точки згори й утримуйте висотні пости.',atmosphere:'snow',theme:'mountain',score:'mountain',background:'/assets/mountain-pixel-background.png',length:178,exit:170,radio:161,
 ...
 {...common,name:'Сталева зміна',region:'Дніпровщина',brief:'Рухайтеся танком уздовж колій або обійдіть оборону дахами вагонів. Займіть пости, підніміться до диспетчерської та відкрийте шлях евакуації.',atmosphere:'industrial',theme:'rail',score:'rail',background:'/assets/rail-pixel-background.png',length:188,exit:181,radio:172,mounts:[9,104],
