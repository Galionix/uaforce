import {FINAL_MISSION} from './campaign.ts';
...
export function saveProgress(p:Progress){try{localStorage.setItem('uaforce.campaign.v1',JSON.stringify({...p,campaignSize:MISSIONS.length,campaignRoute:1}));}catch{}}
