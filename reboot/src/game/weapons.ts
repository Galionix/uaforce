...
export const WEAPONS:Record<HeroId,WeaponSpec>={
 ...
 klychko:{"mode": "melee", "magazine": 0, "reloadTime": 0, "cooldown": 0.35, "damage": 18, "projectileSpeed": 20, "range": 2.3, "burst": 0, "burstPause": 0},
 taira:{"mode": "single", "magazine": 3, "reloadTime": 1.8, "cooldown": 0.42, "damage": 52, "projectileSpeed": 20, "range": 6, "burst": 0, "burstPause": 0},
