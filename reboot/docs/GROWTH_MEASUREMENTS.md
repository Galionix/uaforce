...
## Мобильное дополнение, 10 сентября

Production обновлён до `23ce9cb4-e504-49d0-a4de-e805d8e21fb4`: сенсорное управление и мобильный путь /tiktok. Подробности и границы проверок — `MOBILE_CONTROLS.md`. Схема Analytics Engine не менялась; отдельной сегментации touch/keyboard в событиях пока нет.
